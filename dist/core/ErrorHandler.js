...
exports.ErrorHandler = exports.ErrorSource = void 0;
var ErrorSource;
...
ErrorHandler.USER_MESSAGES = {
    PLAN_EXPIRED: "Tu suscripción ha expirado. Causa: La fecha de vigencia de tu plan ha sido superada. Solución: Por favor, contacta con soporte o accede al panel de facturación para renovar tu plan y recuperar el acceso.",
    INVALID_PATH_TYPE: "Error de formato de datos. Causa: El sistema esperaba un tipo de dato diferente en la ruta solicitada. Solución: Verifica que la información guardada sea correcta o contacta al equipo técnico para corregir la estructura del dato.",
    INFRA_ERROR: "Fallo de comunicación con la base de datos. Causa: Hubo un problema técnico al intentar leer o escribir datos en la infraestructura. Solución: Verifica tu conexión a internet y reintenta la operación en unos segundos. Si el problema persiste, informa al administrador.",
    INFRA_EXECUTION_ERROR: "Error en la ejecución del motor. Causa: El servidor de infraestructura encontró un problema al procesar la lógica del comando. Solución: Revisa que los parámetros enviados sean correctos y vuelve a intentarlo. Si el error persiste, es posible que sea un bug interno.",
    INFRA_CONNECTION_ERROR: "Servidor de infraestructura no disponible. Causa: No se pudo establecer una conexión con el API de datos (timeout o servidor caído). Solución: Verifica que el servidor de infraestructura esté encendido y que no haya bloqueos de red o firewall.",
    AUTH_FAILED: "Sesión no válida o expirada. Causa: Tu token de acceso ya no es reconocido por el sistema. Solución: Por favor, cierra sesión e inicia sesión nuevamente para generar un nuevo token de acceso.",
